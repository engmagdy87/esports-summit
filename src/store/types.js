const user = {
  ...
  mutations: {
    ...
    SET_IS_VERIFICATION_MAIL_SENT:
      "user/mutations/SET_IS_VERIFICATION_MAIL_SENT",
...
const story = {
  mutations: {
    ...
    SET_SUMMIT_HISTORY_GAMES: "story/mutations/SET_SUMMIT_HISTORY_GAMES",
    SET_IS_SUMMIT_HISTORY_GAMES_FETCHED:
      "story/mutations/SET_IS_SUMMIT_HISTORY_GAMES_FETCHED"
  },
  actions: {
    FETCH_STORY: "story/actions/FETCH_STORY",
    FETCH_SUMMIT_HISTORY_GAMES: "story/actions/FETCH_SUMMIT_HISTORY_GAMES"
  }
};
...
const sponsors = {
  mutations: {
    ...
    SET_IS_SPONSORS_DATA_FETCHED:
      "sponsors/mutations/SET_IS_SPONSORS_DATA_FETCHED",
    SET_DASHBOARD_SPONSORS_DATA:
      "sponsors/mutations/SET_DASHBOARD_SPONSORS_DATA",
    SET_IS_DASHBOARD_SPONSORS_DATA_FETCHED:
      "sponsors/mutations/SET_IS_DASHBOARD_SPONSORS_DATA_FETCHED",
    SET_FOOTER_SPONSORS_DATA: "sponsors/mutations/SET_FOOTER_SPONSORS_DATA",
    SET_IS_FOOTER_SPONSORS_DATA_FETCHED:
      "sponsors/mutations/SET_IS_FOOTER_SPONSORS_DATA_FETCHED",
  ...
  actions: {
    ...
    FETCH_SPONSORS_FOR_DASHBOARD:
      "sponsors/actions/FETCH_SPONSORS_FOR_DASHBOARD",
...
const popups = {
  ...
  mutations: {
    ...
    SET_IS_DASHBOARD_POPUPS_DATA_FETCHED:
      "popups/mutations/SET_IS_DASHBOARD_POPUPS_DATA_FETCHED",
    SET_RANDOM_POPUP_DATA: "popups/mutations/SET_RANDOM_POPUP_DATA",
    SET_IS_RANDOM_POPUP_DATA_FETCHED:
      "popups/mutations/SET_IS_RANDOM_POPUP_DATA_FETCHED",
...
const testimonials = {
  mutations: {
    SET_DASHBOARD_TESTIMONIALS_DATA:
      "testimonials/mutations/SET_DASHBOARD_TESTIMONIALS_DATA",
    SET_IS_DASHBOARD_TESTIMONIALS_DATA_FETCHED:
      "testimonials/mutations/SET_IS_DASHBOARD_TESTIMONIALS_DATA_FETCHED",
    SET_TESTIMONIALS_DATA: "testimonials/mutations/SET_TESTIMONIALS_DATA",
    SET_IS_TESTIMONIALS_DATA_FETCHED:
      "testimonials/mutations/SET_IS_TESTIMONIALS_DATA_FETCHED",
    REMOVE_DELETED_TESTIMONIAL:
      "testimonials/mutations/REMOVE_DELETED_TESTIMONIAL"
  },
  actions: {
    FETCH_DASHBOARD_TESTIMONIALS:
      "testimonials/actions/FETCH_DASHBOARD_TESTIMONIALS",
...
const games = {
  mutations: {
    ...
    SET_IS_GAMES_CARDS_VIEW_FETCHED:
      "games/mutations/SET_IS_GAMES_CARDS_VIEW_FETCHED",
    SET_DASHBOARD_GAMES_DATA: "games/mutations/SET_DASHBOARD_GAMES_DATA",
    SET_IS_DASHBOARD_GAMES_DATA_FETCHED:
      "games/mutations/SET_IS_DASHBOARD_GAMES_DATA_FETCHED",
    SET_GAME_DETAILS_DATA: "games/mutations/SET_GAME_DETAILS_DATA",
    SET_IS_GAME_DETAILS_DATA_FETCHED:
      "games/mutations/SET_IS_GAME_DETAILS_DATA_FETCHED",
  ...
  actions: {
    ...
    FETCH_GAME_HISTORY_DETAILS: "games/actions/FETCH_GAME_HISTORY_DETAILS",
...
const platforms = {
  mutations: {
    ...
    SET_IS_PLATFORMS_DATA_FETCHED:
      "platforms/mutations/SET_IS_PLATFORMS_DATA_FETCHED",
    SET_DASHBOARD_PLATFORMS_DATA:
      "platforms/mutations/SET_DASHBOARD_PLATFORMS_DATA",
    SET_IS_DASHBOARD_PLATFORMS_DATA_FETCHED:
      "platforms/mutations/SET_IS_DASHBOARD_PLATFORMS_DATA_FETCHED",
    REMOVE_DELETED_PLATFORM: "platforms/mutations/REMOVE_DELETED_PLATFORM"
  },
  actions: {
    FETCH_PLATFORMS: "platforms/actions/FETCH_PLATFORMS",
    FETCH_PLATFORMS_FOR_DASHBOARD:
      "platforms/actions/FETCH_PLATFORMS_FOR_DASHBOARD",
...
const eventParent = {
  mutations: {
    ...
    SET_IS_EVENT_PARENTS_DATA_FETCHED:
      "eventParents/mutations/SET_IS_EVENT_PARENTS_DATA_FETCHED",
    SET_DASHBOARD_EVENT_PARENTS_DATA:
      "eventParents/mutations/SET_DASHBOARD_EVENT_PARENTS_DATA",
    SET_IS_DASHBOARD_EVENT_PARENTS_DATA_FETCHED:
      "eventParents/mutations/SET_IS_DASHBOARD_EVENT_PARENTS_DATA_FETCHED",
    REMOVE_DELETED_EVENT_PARENT:
      "eventParents/mutations/REMOVE_DELETED_EVENT_PARENT"
  },
  actions: {
    FETCH_EVENT_PARENTS: "eventParents/actions/FETCH_EVENT_PARENTS",
    FETCH_EVENT_PARENTS_FOR_DASHBOARD:
      "eventParents/actions/FETCH_EVENT_PARENTS_FOR_DASHBOARD",
...
const regions = {
  mutations: {
    ...
    SET_IS_REGIONS_DATA_FETCHED:
      "regions/mutations/SET_IS_REGIONS_DATA_FETCHED",
    SET_DASHBOARD_REGIONS_DATA: "regions/mutations/SET_DASHBOARD_REGIONS_DATA",
    SET_IS_DASHBOARD_REGIONS_DATA_FETCHED:
      "regions/mutations/SET_IS_DASHBOARD_REGIONS_DATA_FETCHED",
...
const tournaments = {
  mutations: {
    ...
    SET_IS_TOURNAMENTS_DATA_FETCHED:
      "tournaments/mutations/SET_IS_TOURNAMENTS_DATA_FETCHED",
    SET_DASHBOARD_TOURNAMENTS_DATA:
      "tournaments/mutations/SET_DASHBOARD_TOURNAMENTS_DATA",
    SET_FILTERED_TOURNAMENTS_DATA:
      "tournaments/mutations/SET_FILTERED_TOURNAMENTS_DATA",
    SET_IS_DASHBOARD_TOURNAMENTS_DATA_FETCHED:
      "tournaments/mutations/SET_IS_DASHBOARD_TOURNAMENTS_DATA_FETCHED",
    SET_TOURNAMENT_DETAILS_DATA: "games/mutations/SET_TOURNAMENT_DETAILS_DATA",
    SET_IS_TOURNAMENT_DETAILS_DATA_FETCHED:
      "games/mutations/SET_IS_TOURNAMENT_DETAILS_DATA_FETCHED",
    SET_IS_FILTERED_TOURNAMENT_DATA_FETCHED:
      "games/mutations/SET_IS_FILTERED_TOURNAMENT_DATA_FETCHED",
  ...
  actions: {
    ...
    FETCH_TOURNAMENTS_FOR_DASHBOARD:
      "tournaments/actions/FETCH_TOURNAMENTS_FOR_DASHBOARD",
...
const summits = {
  mutations: {
    ...
    SET_IS_SUMMITS_HISTORY_FETCHED:
      "summits/mutations/SET_IS_SUMMITS_HISTORY_FETCHED",
    SET_IS_SUMMIT_DETAILS_FETCHED:
      "summits/mutations/SET_IS_SUMMIT_DETAILS_FETCHED",
    SET_IS_SUMMITS_FETCHED: "summits/mutations/SET_IS_SUMMITS_FETCHED",
    SET_IS_SUMMITS_LIST_FETCHED:
      "summits/mutations/SET_IS_SUMMITS_LIST_FETCHED",
    REMOVE_DELETED_SUMMIT: "summits/mutations/REMOVE_DELETED_SUMMIT",
    SET_COVER_HOME_EVENTS_IMAGE:
      "summits/mutations/SET_COVER_HOME_EVENTS_IMAGE",
    IS_COVER_HOME_EVENTS_IMAGE_FETCHED:
      "summits/mutations/IS_COVER_HOME_EVENTS_IMAGE_FETCHED",
    SET_COVER_CONTACT_US_IMAGE: "summits/mutations/SET_COVER_CONTACT_US_IMAGE",
    SET_COVER_TESTIMONIALS_IMAGE:
      "summits/mutations/SET_COVER_TESTIMONIALS_IMAGE",
    IS_COVER_CONTACT_US_IMAGE_FETCHED:
      "summits/mutations/IS_COVER_CONTACT_US_IMAGE_FETCHED",
    IS_COVER_TESTIMONIALS_IMAGE_FETCHED:
      "summits/mutations/IS_COVER_TESTIMONIALS_IMAGE_FETCHED",
    SET_COVER_GIVEAWAYS_IMAGE: "summits/mutations/SET_COVER_GIVEAWAYS_IMAGE",
    IS_COVER_GIVEAWAYS_IMAGE_FETCHED:
      "summits/mutations/IS_COVER_GIVEAWAYS_IMAGE_FETCHED"
  },
  actions: {
    ...
    FETCH_COVER_HOME_EVENTS_IMAGE:
      "summits/actions/FETCH_COVER_HOME_EVENTS_IMAGE",
    FETCH_COVER_CONTACT_US_IMAGE:
      "summits/actions/FETCH_COVER_CONTACT_US_IMAGE",
    FETCH_COVER_TESTIMONIALS_IMAGE:
      "summits/actions/FETCH_COVER_TESTIMONIALS_IMAGE",
...
const events = {
  mutations: {
    ...
    SET_IS_EVENT_COVER_TYPES_FETCHED:
      "events/mutations/SET_IS_EVENT_COVER_TYPES_FETCHED",
    SET_IS_EVENT_DETAILS_FETCHED:
      "events/mutations/SET_IS_EVENT_DETAILS_FETCHED",
    SET_IS_EVENT_GIVEAWAYS_FETCHED:
      "events/mutations/SET_IS_EVENT_GIVEAWAYS_FETCHED",
    SET_IS_EVENT_OFFERS_FETCHED: "events/mutations/SET_IS_EVENT_OFFERS_FETCHED",
    SET_IS_EVENT_HISTORY_FETCHED:
      "events/mutations/SET_IS_EVENT_HISTORY_FETCHED"
  },
  actions: {
...
const giveaways = {
  mutations: {
    ...
    SET_GIVEAWAY_QUESTION_TYPES:
      "giveaways/mutations/SET_GIVEAWAY_QUESTION_TYPES",
    ...
    SET_IS_REGISTER_AVAILABLE_IN_GIVEAWAY:
      "giveaways/mutations/SET_IS_REGISTER_AVAILABLE_IN_GIVEAWAY",
    SET_AM_I_REGISTERED_IN_GIVEAWAY:
      "giveaways/mutations/SET_AM_I_REGISTERED_IN_GIVEAWAY",
    ...
    SET_IS_GIVEAWAYS_LIST_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAYS_LIST_FETCHED",
    SET_IS_GIVEAWAY_TYPE_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAY_TYPE_FETCHED",
    SET_IS_GIVEAWAY_REGISTERS_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAY_REGISTERS_FETCHED",
    SET_IS_GIVEAWAY_COVER_TYPES_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAY_COVER_TYPES_FETCHED",
    SET_IS_GIVEAWAY_QUESTION_TYPES_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAY_QUESTION_TYPES_FETCHED",
    SET_IS_GIVEAWAY_DETAILS_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAY_DETAILS_FETCHED",
    SET_IS_GIVEAWAY_TOURNAMENTS_FETCHED:
      "giveaways/mutations/SET_IS_GIVEAWAY_TOURNAMENTS_FETCHED",
    SET_IS_REGISTER_AVAILABLE_IN_GIVEAWAY_FETCHED:
      "giveaways/mutations/SET_IS_REGISTER_AVAILABLE_IN_GIVEAWAY_FETCHED",
    SET_AM_I_REGISTERED_IN_GIVEAWAY_FETCHED:
      "giveaways/mutations/SET_AM_I_REGISTERED_IN_GIVEAWAY_GIVEAWAY_FETCHED"
  },
  actions: {
    ...
    FETCH_GIVEAWAY_QUESTION_TYPES:
      "giveaways/actions/FETCH_GIVEAWAY_QUESTION_TYPES",
    ...
    FETCH_IS_REGISTER_AVAILABLE_IN_GIVEAWAY:
      "giveaways/actions/FETCH_IS_REGISTER_AVAILABLE_IN_GIVEAWAY",
    FETCH_AM_I_REGISTERED_IN_GIVEAWAY:
      "giveaways/actions/FETCH_AM_I_REGISTERED_IN_GIVEAWAY",
...
const sponsorsCategories = {
  mutations: {
    SET_SPONSORS_CATEGORIES_DATA:
      "sponsorsCategories/mutations/SET_SPONSORS_CATEGORIES_DATA",
    SET_IS_SPONSORS_CATEGORIES_DATA_FETCHED:
      "sponsorsCategories/mutations/SET_IS_SPONSORS_CATEGORIES_DATA_FETCHED",
    SET_DASHBOARD_SPONSORS_CATEGORIES_DATA:
      "sponsorsCategories/mutations/SET_DASHBOARD_SPONSORS_CATEGORIES_DATA",
    SET_IS_DASHBOARD_SPONSORS_CATEGORIES_DATA_FETCHED:
      "sponsorsCategories/mutations/SET_IS_DASHBOARD_SPONSORS_CATEGORIES_DATA_FETCHED",
    REMOVE_SPONSORS_CATEGORY:
      "sponsorsCategories/mutations/REMOVE_SPONSORS_CATEGORY"
  },
  actions: {
    FETCH_SPONSORS_CATEGORIES:
      "sponsorsCategories/actions/FETCH_SPONSORS_CATEGORIES",
    FETCH_SPONSORS_CATEGORIES_FOR_DASHBOARD:
      "sponsorsCategories/actions/FETCH_SPONSORS_CATEGORIES_FOR_DASHBOARD",
    DELETE_SPONSORS_CATEGORY:
      "sponsorsCategories/actions/DELETE_SPONSORS_CATEGORY",
