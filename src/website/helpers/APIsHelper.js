...
async function loadUserPersona(payload) {
  const response = await post(payload, APIs.LOGIN_WEBSITE_USER);

  return response.data;
}

async function setUserPersona(payload) {
  const response = await post(payload, APIs.REGISTER_WEBSITE_USER);
...
async function getProfile() {
  const response = await getDashboardData(APIs.GET_USER_PROFILE);

  return response.data;
}

async function updateProfile(payload) {
  const response = await postMultipart(payload, APIs.UPDATE_USER_PROFILE);

  return response.data;
}

async function sendMail(payload) {
  const response = await post(payload, APIs.SEND_MAIL);

  return response.data;
}

async function resetPassword(payload) {
  const response = await post(payload, APIs.RESET_PASSWORD);

  return response.data;
}

async function resendVerificationEmail(payload) {
  const response = await post(payload, APIs.RESEND_VERIFICATION_EMAIL);
  return response.data;
}
...
async function sendMessage(payload) {
  const response = await post(payload, APIs.POST_MESSAGE);
...
async function createSummit(payload) {
  const response = await postMultipart(payload, APIs.CREATE_SUMMIT);

  return response.data;
}

async function getStory() {
  const response = await get(APIs.GET_WEBSITE_STORY);

  return response.data;
}

async function getSummits() {
  const response = await getDashboardData(APIs.GET_SUMMITS);

  return response.data;
}

async function getSummitsList() {
  const response = await getDashboardData(APIs.GET_SUMMITS_LIST);

  return response.data;
}

async function removeSummit(id) {
  const response = await deleteData(`${APIs.DELETE_SUMMIT}/${id}`);

  return response;
}

async function editSummit(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_SUMMIT}/${id}`);

  return response;
}

async function getSummitsHistory() {
  const response = await get(APIs.GET_WEBSITE_SUMMIT_HISTORY);
...
async function getSummitDetails(id) {
  const response = await get(
    `${APIs.GET_WEBSITE_SUMMIT_DETAILS}/${id}/summary`
  );
...
async function createEvent(payload) {
  const response = await postMultipart(payload, APIs.CREATE_EVENT);

  return response.data;
}

async function getEvents() {
  const response = await getDashboardData(APIs.GET_EVENTS);

  return response.data;
}

async function getCoverHomeEventsImage() {
  const response = await get(APIs.GET_COVER_HOME_EVENTS_IMAGE);

  return response.data;
}

async function getCoverContactUsImage() {
  const response = await get(APIs.GET_COVER_CONTACT_US_IMAGE);

  return response.data;
}

async function getEventsList() {
  const response = await getDashboardData(APIs.GET_LIST_WEBSITE_EVENTS);

  return response.data;
}

async function getEventsTypes() {
  const response = await getDashboardData(APIs.GET_EVENT_TYPES);

  return response.data;
}

async function getMainEvents() {
  const response = await get(APIs.GET_WEBSITE_MAIN_EVENTS);

  return response.data;
}

async function getSubEvents() {
  const response = await get(APIs.GET_WEBSITE_SUB_EVENTS);

  return response.data;
}

async function getEvent(eventId) {
  const response = await get(`${APIs.GET_WEBSITE_EVENT_DETAILS}/${eventId}`);
...
async function getEventCoverTypes() {
  const response = await getDashboardData(APIs.GET_EVENT_COVER_TYPES);

  return response.data;
}

async function removeEvent(id) {
  const response = await deleteData(`${APIs.DELETE_EVENT}/${id}`);

  return response;
}

async function editEvent(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_EVENT}/${id}`);
...
async function createGiveaway(payload) {
  const response = await postMultipart(payload, APIs.CREATE_GIVEAWAY);
...
async function getDashboardGiveaways() {
  const response = await getDashboardData(APIs.GET_GIVEAWAYS);

  return response.data;
}

async function getCoverGiveawaysImage() {
  const response = await get(APIs.GET_COVER_GIVEAWAY_IMAGE);
...
async function getWebsiteGiveaways(data) {
  const response = await get(APIs.GET_WEBSITE_GIVEAWAYS, {
    params: {
      ...data
    }
  });
...
async function removeGiveaway(id) {
  const response = await deleteData(`${APIs.DELETE_GIVEAWAY}/${id}`);

  return response;
}

async function editGiveaway(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_GIVEAWAY}/${id}`);
...
async function getGiveawaysTypes() {
  const response = await getDashboardData(APIs.GET_GIVEAWAY_TYPES);

  return response.data;
}

async function getGiveawaysCoverTypes() {
  const response = await getDashboardData(APIs.GET_GIVEAWAY_COVER_TYPES);
...
async function getSponsorsForDashboard() {
  const response = await getDashboardData(APIs.GET_LIST_SPONSORS);

  return response.data;
}

async function getSponsorsForFooter() {
  const response = await get(APIs.GET_FOOTER_SPONSORS);

  return response.data;
}

async function getSponsors() {
  const response = await getDashboardData(APIs.GET_SPONSORS);

  return response.data;
}

async function createSponsor(payload) {
  const response = await postMultipart(payload, APIs.CREATE_SPONSOR);

  return response.data;
}

async function removeSponsor(id) {
  const response = await deleteData(`${APIs.DELETE_SPONSOR}/${id}`);

  return response;
}

async function editSponsor(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_SPONSOR}/${id}`);
...
async function getGamesForDashboard() {
  const response = await get(APIs.GET_LIST_GAMES);

  return response.data;
}

async function getGamesCardsView() {
  const response = await get(APIs.GET_LIST_WEBSITE_GAMES);

  return response.data;
}

async function getGames() {
  const response = await getDashboardData(APIs.GET_GAMES);
...
async function createGame(payload) {
  const response = await postMultipart(payload, APIs.CREATE_GAME);

  return response.data;
}

async function removeGame(id) {
  const response = await deleteData(`${APIs.DELETE_GAME}/${id}`);
...
async function editGame(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_GAME}/${id}`);
...
async function getPlatformsForDashboard() {
  const response = await getDashboardData(APIs.GET_LIST_WEBSITE_PLATFORMS);

  return response.data;
}

async function getPlatforms() {
  const response = await getDashboardData(APIs.GET_PLATFORMS);

  return response.data;
}

async function createPlatform(payload) {
  const response = await postMultipart(payload, APIs.CREATE_PLATFORM);

  return response.data;
}

async function removePlatform(id) {
  const response = await deleteData(`${APIs.DELETE_PLATFORM}/${id}`);

  return response;
}

async function editPlatform(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_PLATFORM}/${id}`);
...
async function getRegionsForDashboard() {
  const response = await get(APIs.GET_LIST_REGIONS);

  return response.data;
}

async function getRegions() {
  const response = await getDashboardData(APIs.GET_REGIONS);

  return response.data;
}

async function createRegion(payload) {
  const response = await postMultipart(payload, APIs.CREATE_REGION);

  return response.data;
}
async function removeRegion(id) {
  const response = await deleteData(`${APIs.DELETE_REGION}/${id}`);

  return response;
}

async function editRegion(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_REGION}/${id}`);
...
async function getTournamentsForDashboard() {
  const response = await getDashboardData(APIs.GET_TOURNAMENTS);

  return response.data;
}

async function getTournaments() {
  const response = await get(APIs.GET_LIST_WEBSITE_TOURNAMENTS);
...
async function createTournament(payload) {
  const response = await postMultipart(payload, APIs.CREATE_TOURNAMENT);
...
async function removeTournament(id) {
  const response = await deleteData(`${APIs.DELETE_TOURNAMENT}/${id}`);

  return response;
}

async function editTournament(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_TOURNAMENT}/${id}`);
...
async function getSponsorCategories() {
  const response = await getDashboardData(APIs.GET_SPONSOR_CATEGORIES);

  return response.data;
}

async function getSponsorCategoriesList() {
  const response = await getDashboardData(APIs.GET_LIST_SPONSOR_CATEGORIES);
...
async function removeSponsorCategory(id) {
  const response = await deleteData(`${APIs.DELETE_SPONSOR_CATEGORY}/${id}`);

  return response.data;
}

async function createSponsorCategory(payload) {
  const response = await postMultipart(payload, APIs.CREATE_SPONSOR_CATEGORY);
...
async function getEventParentForDashboard() {
  const response = await getDashboardData(APIs.GET_LIST_EVENTS_PARENTS);

  return response.data;
}

async function getEventParent() {
  const response = await getDashboardData(APIs.GET_EVENTS_PARENTS);

  return response.data;
}

async function createEventParent(payload) {
  const response = await postMultipart(payload, APIs.CREATE_EVENTS_PARENT);

  return response.data;
}

async function removeEventParent(id) {
  const response = await deleteData(`${APIs.DELETE_EVENTS_PARENT}/${id}`);
...
async function getPopupsForDashboard() {
  const response = await getDashboardData(APIs.GET_DASHBOARD_POPUPS);

  return response.data;
}

async function getRandomPopup() {
  const response = await get(APIs.GET_RANDOM_POPUP);

  return response.data;
}

async function createPopup(payload) {
  const response = await postMultipart(payload, APIs.CREATE_POPUP);

  return response.data;
}

async function removePopup(id) {
  const response = await deleteData(`${APIs.DELETE_POPUP}/${id}`);
...
async function editPopup(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_POPUP}/${id}`);
...
async function getTestimonialsForDashboard() {
  const response = await getDashboardData(APIs.GET_DASHBOARD_TESTIMONIALS);

  return response.data;
}

async function getTestimonial() {
  const response = await get(APIs.GET_TESTIMONIALS);

  return response.data;
}

async function createTestimonial(payload) {
  const response = await postMultipart(payload, APIs.CREATE_TESTIMONIAL);

  return response.data;
}

async function removeTestimonial(id) {
  const response = await deleteData(`${APIs.DELETE_TESTIMONIAL}/${id}`);
...
async function editTestimonial(id, data) {
  const response = await postMultipart(data, `${APIs.EDIT_TESTIMONIAL}/${id}`);

  return response;
}

async function getCoverTestimonialsImage() {
  const response = await get(APIs.GET_COVER_TESTIMONIALS_IMAGE);
